...
private val LightColorPalette = ecologicColors(
    brand = Shadow5,
...
private val DarkColorPalette = ecologicColors(
    brand = Shadow1,
...
object ecologicTheme {
    val colors: ecologicColors
        @Composable
        get() = LocalecologicColors.current
}

/**
 * ecologic custom Color Palette
 */
@Stable
class ecologicColors(
    ...
    fun update(other: ecologicColors) {
    ...
    fun copy(): ecologicColors = ecologicColors(
...
@Composable
fun ProvideecologicColors(
    colors: ecologicColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalecologicColors provides colorPalette, content = content)
}

private val LocalecologicColors = staticCompositionLocalOf<ecologicColors> {
    error("No ecologicColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [EcologicTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
